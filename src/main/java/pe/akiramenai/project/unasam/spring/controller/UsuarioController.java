...
public class UsuarioController {
	...
	{
		model.put("listaEstudiantes", uService.listarEstudiantes());
	...
	{
		model.addAttribute("listaUsuarios", uService.listarEstudiantes());
		model.addAttribute("texto", "Lista de Estudiantes");
		return "adminListUsuarios";
	}
